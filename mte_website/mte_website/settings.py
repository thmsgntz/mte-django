"""Django settings for mte_website project.
...
SECRET_KEY = 'django-insecure-38w=cj$i%c72f$0g8ln=s^(s_*fj(70o*-8qu66uxxwb+%##4x'
...
WSGI_APPLICATION = 'mte_website.wsgi.application'
